...
- compatibility minimal surface:
  - `planning`
host-aware 해석 기준은 [HOST-AWARE-INSTALL-SURFACE.md](/Users/ikseong/Desktop/develop/vibecoding/bbang/spec-pack/HOST-AWARE-INSTALL-SURFACE.md)를 따른다.
...
- 현재 installer와 package name은 `spec-pack` 기준으로 공개한다
