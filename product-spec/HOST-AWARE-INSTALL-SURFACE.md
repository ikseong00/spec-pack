...
현재 default shipped pack의 user-facing shared root는 `product-spec`이다.
...
- shared root:
  - `.codex/product-spec/`
- host-visible:
  - `.codex/skills/product-spec-*`
  - `.codex/skills/product-spec-codex-*`
  - `.codex/agents/product-spec-*.md`
...
- host-visible:
  ...
  - `.claude/skills/product-spec-claude-*`
  - `.claude/agents/product-spec-*.md`

## Future Target

future packaging, especially the shipped `product-spec`, should be `host-aware` in content too.
...
- [prebuild/hosts/HOST-OVERLAY-MATRIX.md](/Users/ikseong/Desktop/develop/vibecoding/make-product-spec/product-spec/prebuild/hosts/HOST-OVERLAY-MATRIX.md)
- [prebuild/EXPORT-MANIFEST-CANDIDATE.md](/Users/ikseong/Desktop/develop/vibecoding/make-product-spec/product-spec/prebuild/EXPORT-MANIFEST-CANDIDATE.md)
