...
- 이 저장소의 canonical source는 항상 `product-spec/`이다
...
- canonical skills:
  ...
  - `planning-synthesis`
- canonical agents:
  - producer/checker planning agents under `product-spec/planning/agents/`
...
- canonical skills:
  ...
  - `design-synthesis`
- canonical agents:
  - runner/evaluator design agents under `product-spec/design/agents/`
...
- integrated planning->design loop는 `product-spec/prebuild/`가 canonical이다
