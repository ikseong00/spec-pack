...
이 문서는 `product-spec/` 안에서 어떤 pack이 어떤 상태인지 정리한다.
...
| `prebuild` | shipped | yes | unified default install surface, user-facing root = `product-spec` |
...
- current:
  - `product-spec` as default shipped surface
- next:
...
- [PACKAGING-DECISION.md](/Users/ikseong/Desktop/develop/vibecoding/make-product-spec/product-spec/PACKAGING-DECISION.md)
- [HOST-AWARE-INSTALL-SURFACE.md](/Users/ikseong/Desktop/develop/vibecoding/make-product-spec/product-spec/HOST-AWARE-INSTALL-SURFACE.md)
- [prebuild/PACKAGE-README.md](/Users/ikseong/Desktop/develop/vibecoding/make-product-spec/product-spec/prebuild/PACKAGE-README.md)
- [prebuild/FUTURE-PACKAGING-SURFACE.md](/Users/ikseong/Desktop/develop/vibecoding/make-product-spec/product-spec/prebuild/FUTURE-PACKAGING-SURFACE.md)
